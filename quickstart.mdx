...
<Steps>
  <Step title="Create your TuringDB account" titleSize="h2">
    ...
    <Warning>
      You cannot use the TuringDB instances if you do not have credits (free or purchased) as it will consume credits per hours
    </Warning>
    Use your free credits (with your promo code or contact us at [founders@turingdb.ai](mailto:founders@turingdb.ai) to get your code) or directly purchase new credits (in Profile → Settings → Subscriptions).
  </Step>
  ...
  <Step title="Exemple to create and query a graph" titleSize="h2">
    ...
    See [Workflow Exemples](/workflows_exemples)
  </Step>
  <Step title="Visualise the graph you have created in TuringDB" titleSize="h2">
    ...
    ![Open graph visualisation](/images/get_started/AccessUIgraphviz.png)
