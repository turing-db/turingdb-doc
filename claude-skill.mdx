...
description: "Install the TuringDB Claude Code skill with `npx skills add https://github.com/turing-db/turingdb-skills` so Claude can start, query, and write to TuringDB for you."
---
