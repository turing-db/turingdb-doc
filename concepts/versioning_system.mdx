...
This submits your changes to the main branch and merges all its commits. You can then inspect your updated graph history. (`CALL db.history()` is the way to view history — there is no bare `history` command.)
