...
TuringDB supports a subset of the CYPHER query language.
...
<Note> In our autumn 2025 release we will be supporting nearly 100% of Cypher. </Note>
...
On top of supporting queries which return or alter information *in the graph*, TuringDB supports a number of *“metaqueries”* which return information, or metadata, *about the graph*.
