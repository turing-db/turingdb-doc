...
8. `CALL gnn.neighbourhoodSample(input_nodes, sample_size, seed=rng())` - for each node, `n`, in `input_nodes`, produce a uniformly distributed random samples of the outgoing edges of `n`
