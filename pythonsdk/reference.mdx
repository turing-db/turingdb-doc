...
client.query('CREATE (:Protein({name:"APOE"}))')

client.query("""
CREATE
(apoe_gene:Gene {name: 'APOE', chromosome: '19', location: '19q13.32'}),
...
df = client.query("MATCH (n:Gene{name~='apoe'}) RETURN n.name, n.id")
print(df)
```
